"use strict"; 
/**
 * Crea il form per il sign up delle aziende
 * @returns form
 */
function getSignupAgency() {
    //array per valori attributi e testo tag
    const name = ['email', 'Ragione sociale o denominazione', 'text', 'Nome', 'exampleInputPassword1', 'Password', 'password', 'Password', 'luogo', 'Luogo', 'text', 'Luogo', 'settore', 'Settore', 'text', 'Settore']; 
    //creo elementi
  ...
  export default getSignupAgency; 