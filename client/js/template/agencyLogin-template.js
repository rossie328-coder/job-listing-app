...
/**
 * Costruisce il form di login per le aziende
 * @returns form
 */
function getAgencyLogin() {
    //array per valori attributi e testo tag
    const name = ['nome', 'Ragione sociale o denominzaione', 'text', 'Nome', 'exampleInputPassword1', 'Password', 'password', 'Password']; 
    //creo elementi
